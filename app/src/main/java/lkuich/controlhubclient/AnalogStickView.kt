...
class AnalogStickView : View {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        mExampleString = a.getString(
                R.styleable.AnalogStickView_exampleString)
        mExampleColor = a.getColor(
                R.styleable.AnalogStickView_exampleColor,
                mExampleColor)
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.AnalogStickView_exampleDimension,
                mExampleDimension)

        if (a.hasValue(R.styleable.AnalogStickView_exampleDrawable)) {
            exampleDrawable = a.getDrawable(
                    R.styleable.AnalogStickView_exampleDrawable)
